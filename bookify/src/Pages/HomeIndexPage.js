export default function HomeIndexPage() {
    return (
        <div className="bg-gradient-to-r from-purple-500 to-indigo-600 min-h-screen">
            <header className="fixed top-0 left-0 right-0 p-5 flex justify-between items-center bg-white shadow-md max-w-full mx-auto rounded-full">
                ...
                <div className="flex items-center gap-3 bg-gray-100 rounded-full py-2 px-4 shadow-md hover:shadow-lg transition-all duration-300">
