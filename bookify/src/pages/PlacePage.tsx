...
export default function PlacePage() {
    const { id } = useParams();
    const [place, setPlace] = useState<{ title: string; address: string, description: string, photos: string[] } | null>(null);
        ...
        <div className="mt-4 bg-gray-100 -mx-8 px-8 py-8">
            ...
            <div className="relative">
                <div className="grid gap-2 grid-cols-[2fr_1fr]">
                    <div className="h-full">                {place.photos?.[0] && (
                        <div>
                            <img className="w-full h-full aspect-square object-cover" src={'http://localhost:4000/uploads/' + place.photos[0]} />
                        </div>
